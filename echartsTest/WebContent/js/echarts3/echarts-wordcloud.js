...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(global) {
	  ...
	  var WordCloud = function WordCloud(elements, options) {
	    ...
	    var getRotateDeg = function getRotateDeg(baseNum) {
	      ...
	      if (rotationRange === 0) {
	        return minRotation;
	      	...
	      	//修改原來的角度随机获取，改为现在根据序列值得index来获取。
			//return minRotation + Math.round(Math.random() * rotationRange / rotationStep) * rotationStep;
	      return minRotation + Math.round(baseNum * rotationRange / rotationStep) * rotationStep;
	    };
	    ...
	    var putWord = function putWord(item, baseNum) {
	      ...
	      var rotateDeg = getRotateDeg(baseNum);
	    ...
	    var start = function start() {
	      ...
	      var timer = loopingFunction(function loop() {
	        ...
	        var drawn = putWord(settings.list[i], i/settings.list.length);
